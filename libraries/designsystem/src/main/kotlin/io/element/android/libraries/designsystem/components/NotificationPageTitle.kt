 ...
 * @param iconStyle the style of the [NotificationIcon] to display
 ...
 */
@Composable
fun NotificationPageTitle(
    title: AnnotatedString,
    iconStyle: NotificationIcon.Style,
...
@PreviewsDayNight
@Composable
internal fun NotificationPageTitleWithIconFullPreview(@PreviewParameter(NotificationIconStyleProvider::class) style: NotificationIcon.Style) {
    ElementPreview {
        NotificationPageTitle(
...
@PreviewsDayNight
@Composable
internal fun NotificationPageTitleWithIconMinimalPreview() {
    ElementPreview {
        NotificationPageTitle(
            modifier = Modifier.padding(top = 24.dp),
            title = "Headline",
            iconStyle = NotificationIcon.Style.Default(CompoundIcons.CheckCircleSolid()),
        )
    }
}
