...
@PreviewsDayNight
@Composable
internal fun NewCustomPageTitleWithIconFullPreview(@PreviewParameter(RecoveryKeyIconStyleProvider::class) style: RecoveryKeyIcon.Style) {
    ElementPreview {
        NewCustomPageTitle(
...
@PreviewsDayNight
@Composable
internal fun NewCustomPageTitleWithIconMinimalPreview() {
    ElementPreview {
        NewCustomPageTitle(
            modifier = Modifier.padding(top = 24.dp),
            title = "Headline",
