...
@PreviewsDayNight
@Composable
internal fun NewPageTitleWithIconFullPreview(@PreviewParameter(NewBigIconStyleProvider::class) style: NewBigIcon.Style) {
    ElementPreview {
        NewPageTitle(
...
@PreviewsDayNight
@Composable
internal fun NewPageTitleWithIconMinimalPreview() {
    ElementPreview {
        NewPageTitle(
            modifier = Modifier.padding(top = 24.dp),
            title = "Headline",
