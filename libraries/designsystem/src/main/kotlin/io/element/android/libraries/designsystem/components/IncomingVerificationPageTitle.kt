 ...
 * @param iconStyle the style of the [NewBigIcon] to display
 ...
 */
@Composable
fun IncomingVerificationPageTitle(
    title: AnnotatedString,
    iconStyle: NewBigIcon.Style,
...
@PreviewsDayNight
@Composable
internal fun IncomingVerificationPageTitleWithIconFullPreview(@PreviewParameter(NewBigIconStyleProvider::class) style: NewBigIcon.Style) {
    ElementPreview {
        IncomingVerificationPageTitle(
...
@PreviewsDayNight
@Composable
internal fun IncomingVerificationPageTitleWithIconMinimalPreview() {
    ElementPreview {
        IncomingVerificationPageTitle(
            modifier = Modifier.padding(top = 24.dp),
            title = "Headline",
            iconStyle = NewBigIcon.Style.Default(CompoundIcons.CheckCircleSolid()),
        )
    }
}
