 ...
 * Specific implementations can extend this class and override methods as needed.
 */
abstract class BasePasskeyService(
    ...
    init {
        Timber.d("Initializing ${this.javaClass.simpleName} with base URL: $baseUrl for user: $userId")
    }
